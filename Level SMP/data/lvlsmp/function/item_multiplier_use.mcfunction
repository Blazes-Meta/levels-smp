...
execute at @e[type=silverfish, tag=lvlsmp.callMultiplier] as @p if score @s lvlsmp.permanentMultiplierUses >= permanentMultiplierCap lvlsmp.settings run function lvlsmp:give/xp_multiplier
